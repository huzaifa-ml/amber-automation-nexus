    ...
    <Section id="projects">
      ...
      >
        ...
        <div
          ...
          className={`pointer-events-none absolute left-0 top-0 z-20 hidden w-[16rem] rounded-xl border border-gold/25 bg-card/95 p-3 shadow-[0_18px_50px_-20px_color-mix(in_oklab,var(--gold)_45%,transparent)] backdrop-blur-sm transition-[opacity,scale] duration-300 [@media(hover:hover)and(pointer:fine)]:lg:block ${
